    ...
    return (
      <View style={styles.container}>
        <View style={styles.noNotificationsContainer}>
          ...
          <Text style={styles.noNotificationsText}>Go and explore our centers to start receiving notifications.</Text>
          <TouchableOpacity
            style={styles.exploreButton}
            onPress={handleExploreCenters}
          >
            <Text style={styles.buttonText}>Explore Centers</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
